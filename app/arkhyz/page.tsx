...
export default function JilySuPage() {
  ...
  <div className="relative z-10 mx-auto w-full max-w-7xl">
    ...
    <p className="mt-7 max-w-2xl text-lg leading-8 text-[#F5EFE6]/75 md:text-xl">
      Канатная дорога, древние храмы и горные пейзажи Архыза.
    </p>
...
<section className="bg-[#101820] px-6 py-14 md:py-20">
  ...
  <span className="text-2xl font-semibold">5 200 ₽</span>
</div>
        </div>
      </div>
    ...
    <div className="space-y-10">
      {[
...

        {
          ...
          desc: "Одна из самых красивых дорог маршрута с панорамными видами на Кавказские горы.",
        },

        {
          title: "Смотровая на Эльбрус",
          desc: "Останавливаемся на обзорной площадке с красивым видом на Эльбрус и окружающие хребты.",
        },
        ...
        {
          title: "Шаонинский храм X века",
          desc: "Посещаем один из древнейших христианских храмов Кавказа с красивыми видами на ущелье.",
        },

        {
          title: "Посёлок Романтик и канатная дорога",
          desc: "Главная часть маршрута. Поднимаемся по канатной дороге и наслаждаемся горными панорамами Архыза.",
        },

        {
          title: "Обед",
          desc: "Останавливаемся на обед в местном заведении перед продолжением маршрута.",
        },

        {
          title: "Аланское городище",
          desc: "Посещаем древнее Аланское городище и самые древние храмы на территории России.",
        },

        {
          title: "Лик Христа",
          desc: "По желанию поднимаемся к знаменитому Лику Христа. Подъем включает около 450 ступеней.",
        },
      ].map((step, index) => (
        <div
          key={index}
    ...
    <div className="space-y-5">
      {[
...

        {
          ...
          answer:
            "Питание, ЭКО сборы, канатная дорога и личные расходы.",
        },
