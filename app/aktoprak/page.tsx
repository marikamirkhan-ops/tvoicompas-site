...
export default function JilySuPage() {
  ...
  <div className="absolute inset-0 bg-[url('/images/aktoprak-main.webp')] bg-cover bg-center opacity-60" />
...
>
      {[
        "/images/aktoprak-1.webp",
        "/images/aktoprak-2.webp",
        "/images/aktoprak-3.webp",
        "/images/aktoprak-4.webp",
        "/images/aktoprak-5.webp",
        "/images/aktoprak-6.webp",
        "/images/aktoprak-7.webp",
        "/images/aktoprak-8.webp",
      ].map((image, index) => (
        <div
          key={index}
