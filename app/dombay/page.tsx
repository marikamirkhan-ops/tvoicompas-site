...
export default function JilySuPage() {
  ...
  <div className="absolute inset-0 bg-[url('/images/dombay-main.webp')] bg-cover bg-center opacity-60" />
...
>
      {[
        "/images/dombay-1.webp",
        "/images/dombay-2.webp",
        "/images/dombay-3.webp",
        "/images/dombay-4.webp",
        "/images/dombay-5.webp",
        "/images/dombay-6.webp",
        "/images/dombay-7.webp",
        "/images/dombay-8.webp",
      ].map((image, index) => (
        <div
          key={index}
      ...
      {[
        {
          ...
          desc: "Отправляемся в путешествие около 7:00 утра. Забираем туристов по указанным адресам.",
        },
        {
          title: "Перевал Гум-Башы",
          desc: "Одна из самых живописных дорог маршрута с горными панорамами и ощущением настоящего Кавказа.",
        },
        {
          title: "Смотровая на Эльбрус",
          desc: "Останавливаемся на обзорной площадке, откуда открывается красивый вид на Эльбрус и горные хребты.",
        },
        {
          title: "Сырные пещеры",
          desc: "Необычная природная локация с фактурными скалами и атмосферными видами для фотографий.",
        },
        {
          title: "Озеро Къара-Кёл",
          desc: "Небольшое горное озеро с красивыми отражениями и спокойной атмосферой.",
        },
        {
          title: "Горная река Уллу-Муруджу",
          desc: "Остановка у чистой горной реки с прозрачной водой и красивыми природными видами.",
        },
        {
          title: "Домбай и канатная дорога",
          desc: "Главная часть маршрута. Поднимаемся по канатной дороге, наслаждаемся видами гор, ущелий и вершин Домбая.",
        },
        {
          title: "Обед",
          desc: "Останавливаемся на обед в местном заведении, где порции приятно удивляют своим масштабом.",
        },
        {
          title: "Храм X века",
          desc: "На обратном пути посещаем Шаонинский или Сентинский храм X века — одну из древних святынь Кавказа.",
        },
      ].map((step, index) => (
        <div
          key={index}
    ...
    <div className="space-y-5">
      {[
...

        {
          ...
          answer:
            "Питание, ЭКО сборы, канатная дорога иличные расходы.",
        },
