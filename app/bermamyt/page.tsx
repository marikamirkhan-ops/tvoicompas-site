...
export default function JilySuPage() {
  ...
  <div className="absolute inset-0 bg-[url('/images/bermamyt-main.jpg')] bg-cover bg-[60%_center] md:bg-center opacity-60" />
...
>
    ...
    <p className="mt-7 max-w-2xl text-lg leading-8 text-[#F5EFE6]/75 md:text-xl">
      Кавказский гранд-каньон, где открываются лучшие виды на Эльбрус и весь Кавказский хребет
    </p>
      ...
      {[
        {
          ...
          desc: "Отправляемся в путешествие рано утром — около 7:00. Забираем туристов по указанным адресам.",
        },

        {
          title: "Завтрак с видом на Эльбрус",
          desc: "Через полчаса после выезда останавливаемся в кафе с красивым видом на Эльбрус. По желанию можно позавтракать перед дорогой.",
        },

        {
          title: "Эшкаконская долина",
          desc: "Первая большая смотровая площадка маршрута с панорамными видами на Эшкаконскую долину и окружающие горные хребты.",
        },

        {
          title: "Схауатское ущелье и Малый Бермамыт",
          desc: "Останавливаемся у смотровой на Схауатское ущелье, посещаем Малый Бермамыт и знаменитую «Лавочку счастья».",
        },

        {
          title: "Плато Большой Бермамыт",
          desc: "Главная часть маршрута. Посещаем самые красивые локации плато:",
          extra: [
            "Мостик над обрывом",
            "Амфитеатр (Колизей)",
            "Скалы монахи",
        ...
        {
          title: "Обед",
          desc: "По желанию останавливаемся на обед перед обратной дорогой.",
        },
      ].map((step, index) => (
        <div
          key={index}
