...
<section id="routes" className="scroll-mt-16 bg-[#101820] px-6 py-14 text-[#F5EFE6] md:py-20">
...
<section
  id="how"
  className="scroll-mt-16 bg-[#101820] px-6 py-14 text-[#F5EFE6] md:py-20"
>
  <div className="mx-auto max-w-7xl">
    <div className="mb-10 max-w-3xl">
      <p className="mb-3 text-xs uppercase tracking-[0.35em] text-[#D6B16A] md:text-sm">
...
<section
  id="faq"
  className="scroll-mt-16 bg-[#0D141B] px-6 py-14 text-[#F5EFE6] md:py-20"
>
...
<section
  id="contacts"
  className="scroll-mt-16 relative overflow-hidden bg-[#101820] px-6 py-14 text-[#F5EFE6] md:py-20"
>
