    ...
    <div className="space-y-10">
      {[
...

        {
          ...
          desc: "Первая остановка маршрута — живописный замок посреди озера и виноградников.",
        },
        ...
        {
          title: "Черекская теснина",
          desc: "Проезжаем через узкое горное ущелье с отвесными скалами и красивыми видами.",
        },
