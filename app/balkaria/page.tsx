...
export default function JilySuPage() {
  ...
  <div className="absolute inset-0 bg-[url('/images/balkaria-main.webp')] bg-cover bg-center opacity-60" />
...
>
    ...
    <h1 className="max-w-4xl text-4xl font-semibold leading-tight tracking-tight md:text-7xl">
      Экскурсия на Верхнюю Балкарию
    </h1>

    <p className="mt-7 max-w-2xl text-lg leading-8 text-[#F5EFE6]/75 md:text-xl">
      Горные ущелья, голубые озера, язык Троля и самые красивые дороги Балкарии.
    </p>
...
<section className="bg-[#101820] px-6 py-14 md:py-20">
  ...
  <span className="text-2xl font-semibold">5 500 ₽</span>
</div>
        </div>
      </div>
...
>
      {[
        "/images/balkaria-1.webp",
        "/images/balkaria-2.webp",
        "/images/balkaria-3.webp",
        "/images/balkaria-4.webp",
        "/images/balkaria-5.webp",
        "/images/balkaria-6.webp",
        "/images/balkaria-7.webp",
        "/images/balkaria-8.webp",
      ].map((image, index) => (
        <div
          key={index}
    ...
    <div className="space-y-10">
      {[
...

        {
          ...
          desc: "Первая остановка маршрута — живописный средневековый замок в романском стиле, стоящий посреди озера и виноградников.",
        },

        {
          title: "Хуламо-Безенгийское ущелье",
          desc: "Одна из самых красивых дорог Кабардино-Балкарии с панорамами горных ущелий и вершин.",
        },

        {
          title: "Водопад Тыжынты-Суу",
          desc: "Посещаем водопад и знаменитую «Плачущую стену» среди скал и горных дорог.",
        },

        {
          title: "Язык Тролля",
          desc: "Одна из самых известных фотолокаций маршрута с красивыми видами на ущелье.",
        },

        {
          title: "Обед",
          desc: "Останавливаемся на обед и знакомимся с блюдами традиционной балкарской кухни.",
        },

        {
          title: "Голубые озера",
          desc: "Посещаем знаменитые карстовые озера с необычным цветом воды.",
        },

        {
          title: "Верхняя Балкария",
          desc: "Посещаем древнее селение Верхняя Балкария и башню Абаевых.",
        },
      ].map((step, index) => (
        <div
          key={index}
