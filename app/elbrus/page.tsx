...
export default function JilySuPage() {
  ...
  <div className="absolute inset-0 bg-[url('/images/elbrus-main.webp')] bg-cover bg-center opacity-60" />
...
>
    ...
    <p className="mt-7 max-w-2xl text-lg leading-8 text-[#F5EFE6]/75 md:text-xl">
      Озеро Гижгит, Эльбрус и горные пейзажи Приэльбрусья за один день.
    </p>
...
>
      {[
        "/images/elbrus-1.webp",
        "/images/elbrus-2.webp",
        "/images/elbrus-3.webp",
        "/images/elbrus-4.webp",
        "/images/elbrus-5.webp",
        "/images/elbrus-6.webp",
        "/images/elbrus-7.webp",
        "/images/elbrus-8.webp",
      ].map((image, index) => (
        <div
          key={index}
  ...
  <div className="mx-auto max-w-5xl">
    ...
    <div className="space-y-10">
      {[
        ...
        {
          title: "Поляна Азау и канатная дорога",
          desc: "Главная часть маршрута. Поднимаемся по канатной дороге на Эльбрус и наслаждаемся видами Приэльбрусья.",
        },
        {
          title: "Поляна нарзанов",
          desc: "Останавливаемся у природных минеральных источников среди хвойного леса и горных пейзажей.",
        },
        {
          title: "Обед",
          desc: "Заезжаем на обед — по желанию можно попробовать знаменитые шашлыки Кабардино-Балкарии.",
        },
        {
          title: "Ущелье Адыр-Суу",
          desc: "Посещаем нижнюю площадку ущелья Адыр-Суу с красивой горной рекой и атмосферными видами.",
        },
      ].map((step, index) => (
        <div
          key={index}
