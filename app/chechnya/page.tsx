...
export default function JilySuPage() {
  ...
  <div className="absolute inset-0 bg-[url('/images/chechnya-main.webp')] bg-cover bg-center opacity-60" />
...
>
    ...
    <h1 className="max-w-4xl text-4xl font-semibold leading-tight tracking-tight md:text-7xl">
      Экскурсия по Чеченской республике
    </h1>

    <p className="mt-7 max-w-2xl text-lg leading-8 text-[#F5EFE6]/75 md:text-xl">
      Три города Чечни, панорамы Грозного и знаменитые мечети республики.
    </p>
...
<section className="bg-[#101820] px-6 py-14 md:py-20">
  ...
  <span className="text-2xl font-semibold">6 500 ₽</span>
</div>
        </div>
      </div>
...
>
      {[
        "/images/chechnya-1.webp",
        "/images/chechnya-2.webp",
        "/images/chechnya-3.webp",
        "/images/chechnya-4.webp",
        "/images/chechnya-5.webp",
        "/images/chechnya-6.webp",
        "/images/chechnya-7.webp",
        "/images/chechnya-8.webp",
      ].map((image, index) => (
        <div
          key={index}
      ...
      {[
        {
          ...
          desc: "Отправляемся в путешествие около 5:00–6:00 утра. Забираем туристов по указанным адресам.",
        },
        ...
        {
          title: "Грозный",
          desc: "Главная часть маршрута — знакомство со столицей Чеченской Республики.",
          extra: [
            "Мемориальный комплекс славы имени А.А. Кадырова",
            "Прогулка по центру города",
            "Парк Цветов и набережная реки Сунжа",
            "Грозный-Сити и смотровая площадка",
            "Мечеть «Сердце Чечни»",
        ...
        {
          title: "Шали",
          desc: "Посещаем знаменитую мечеть «Гордость Мусульман» — одну из крупнейших мечетей Европы.",
        },

        {
          title: "Аргун",
          desc: "Завершаем маршрут посещением мечети «Сердце матери» имени Аймани Кадыровой.",
        },
      ].map((step, index) => (
        <div
          key={index}
