...
export default function JilySuPage() {
  ...
  <div className="absolute inset-0 bg-[url('/images/jilysu-main.webp')] bg-cover bg-center opacity-60" />
...
>
      {[
        "/images/jilysu-1.webp",
        "/images/jilysu-2.webp",
        "/images/jilysu-3.webp",
        "/images/jilysu-4.webp",
        "/images/jilysu-5.webp",
        "/images/jilysu-6.webp",
        "/images/jilysu-7.webp",
        "/images/jilysu-8.webp",
      ].map((image, index) => (
        <div
          key={index}
