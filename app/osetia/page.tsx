...
>
    ...
    <p className="mt-7 max-w-2xl text-lg leading-8 text-[#F5EFE6]/75 md:text-xl">
      Горные ущелья, древние башни и город мертвых - самые атмосферные локации Северной Осетии
    </p>
  ...
  <div className="mx-auto max-w-5xl">
    ...
    <div className="space-y-10">
      {[
        ...
        {
          title: "Завтрак",
          desc: "Через пару часов после выезда останавливаемся на завтрак перед дальней дорогой.",
        },

        {
          title: "Кармадонское ущелье",
          desc: "Посещаем печально знаменитое ущелье с красивыми горными пейзажами и памятными местами жертвам ледника Колка.",
        },

        {
          title: "Смотровая в селении Кани",
          desc: "Останавливаемся на обзорной площадке с панорамными видами на горные ущелья.",
        },

        {
          title: "Даргавс — город мертвых",
          desc: "Посещаем один из самых известных исторических комплексов Кавказа.",
        },

        {
          title: "Колесо Балсага",
          desc: "Остановка у известного арт-объекта среди горных пейзажей Осетии.",
        },

        {
          title: "Арт-объект «АЕ»",
          desc: "Посещаем одну из популярных современных локаций маршрута.",
        },

        {
          title: "Башня Курта и Тага",
          desc: "Древняя башня, связанная с легендами и историей Осетии.",
        },

        {
          title: "Обед",
          desc: "Останавливаемся на обед и пробуем знаменитые осетинские пироги.",
        },

        {
          title: "Аланский монастырь",
          desc: "Посещаем Аланский Успенский мужской монастырь среди горных склонов.",
        },

        {
          title: "Дзивгивская крепость XIII века",
          desc: "Осматриваем древнюю крепость, встроенную прямо в скалы.",
        },

        {
          title: "Куртатинское ущелье",
          desc: "Завершаем маршрут красивыми видами Куртатинского ущелья и каньона Кадаргаван.",
        },
      ].map((step, index) => (
        <div
          key={index}
